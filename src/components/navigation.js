    ...
    return (
        <NavigationStyled>
            ...
            <ul className="nav-items">
                ...
                <li className="nav-item">
                    <NavLink to="/portfolios" activeClassName="active-class">Portfolisos</NavLink>
                </li>
                <li className="nav-item">
                    <NavLink to="/blogs" activeClassName="active-class">Blogs</NavLink>
                </li>
                <li className="nav-item">
                    <NavLink to="/contact" activeClassName="active-class">Contacts</NavLink>
                </li>
            </ul>
        ...
        li{
            ...
            a{
                ...
                &::before{
                    ...
                    height: 50%;
                    background-color: var(--primary-color);
                    transition: All .4s cubic-bezier(1,0,.06,.85);
                    z-index: 3;
                    opacity: 0.21;
                }
            }
